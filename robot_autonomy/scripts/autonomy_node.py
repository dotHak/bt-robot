...
Example usage:
  ros2 run robot_autonomy autonomy_node.py
  ros2 run robot_autonomy autonomy_node.py --ros-args -p location_file:=/path/to/my/file.yaml
  ros2 run robot_autonomy autonomy_node.py --ros-args -p tree_type:=queue -p target_color:=green
"""
...
default_location_file = os.path.join(
    get_package_share_directory("robot_worlds"), "maps", "sim_house_locations.yaml"
)
